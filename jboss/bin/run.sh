...
### $Id: run.sh,v 1.3 2005/11/02 13:24:17 marco Exp $ ###
...
# ML, Mayking: added path for JasperReports.
JAVA_OPTS="$JAVA_OPTS -Dprogram.name=$PROGNAME -DREPORT_HOME=$COMPIERE_HOME/reports"
