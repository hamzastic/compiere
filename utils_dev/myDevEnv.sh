...
#	
# 	$Header: /opt/mercurial/repository/CVSRepo/compiere/compiere-all/utils_dev/myDevEnv.sh,v 1.4 2005/04/07 19:02:04 marco Exp $
#
...
export COMPIERE_ROOT=$COMPIERE_SOURCE/compiere
...
export COMPIERE_INSTALL=$COMPIERE_SOURCE/compiere/install
